...
o.bind("SUPER + SHIFT + O", "Toggle menu", "omarchy-menu toggle toggle")
o.bind("SUPER + SHIFT + H", "Hardware menu", "omarchy-menu toggle hardware")
...
o.bind("SUPER + SHIFT + K", "Herdr keybindings", "omarchy-menu-herdr-keybindings")
...
o.bind("SUPER + O", "Extract text (OCR) from screenshot", "omarchy-capture-text")
